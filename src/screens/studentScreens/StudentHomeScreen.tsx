...
const StudentHomeScreenSkeleton = () => {
    return (
        <SafeAreaView className="flex-1 bg-bg-1">
            ...
            >
                ...
                <View className="gap-3">
                    ...
                    <View className="flex-row gap-3">
                        <View className="h-32 w-72 bg-bg-2 border border-border rounded-2xl animate-pulse" />
                        <View className="h-32 w-24 bg-bg-2 border border-border rounded-2xl opacity-50 animate-pulse" />
                    </View>
                </View>
