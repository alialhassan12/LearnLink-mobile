    ...
    return(
        ...
        >
                ...
                >
                    ...
                    <Pressable
                        className="absolute top-0 left-0 right-0 bottom-0 bg-black/20"
                        onPress={() => setOpen(false)}
                    />
                    {/* modal card */}
                    <View className="relative mt-10 mb-10 bg-bg-2 rounded-2xl overflow-hidden shadow-2xl">
                        <ScrollView
                            className={`w-full px-4 pt-5 pb-8`}
                            showsVerticalScrollIndicator={false}
                        >
                            
                            <View className="w-full flex flex-col gap-2 py-8 px-4">
                                ...
                                <View className="w-full gap-2">
                                    <Pressable
                                        className="bg-primary py-4 px-8 rounded-xl mt-8 active:scale-95 transition-transform duration-200"
                                    ...
                                    {isModal&&(
                                        <Pressable
                                            className="bg-transparent border border-primary py-4 px-8 rounded-xl mb-4 active:scale-95 transition-transform duration-200"
                                            onPress={() => setOpen(false)}
                                        >
                                            <Text className="text-primary text-lg font-bold text-center">Close</Text>
                                        </Pressable>
                                    )}
                                </View>
                            </View>
